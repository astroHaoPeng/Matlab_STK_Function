function y = GetDataFrom_Fom_NAsset_PercentAbove_Fun(fom,PercentAbove,Satisfaction_Threshold)
%   获取Fom->Static Satisfaction->Percent Satisfiedd的数据
fom.SetDefinitionType('eFmNAssetCoverage');
fom.Definition.SetComputeType('ePercentAbove');
fom.Definition.Compute.PercentLevel=PercentAbove;
